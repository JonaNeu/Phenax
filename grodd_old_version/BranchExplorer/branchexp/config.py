...
from branchexp.runners.infos import VALID_RUNNERS
...
def setup(args, config_file = None):
    ...
    try:
        ...
        quit( "An error occured during config loading, fix your config file: "
              + str(exception) )
    return config
...
def check_tools(working_dir, config):
    ...
    """
    log.info("Checking tools and environment")
